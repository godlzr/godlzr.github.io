  ...
  [
    [
      ...
      [
        ...
        ["dismiss", 6],
        ["el", 7],
        ["enableBackdropDismiss", 1, 0, "enable-backdrop-dismiss", 3],
        ["event", 1],
        ["imageIndex", 1, 0, "image-index", 4],
        ["imageUrls", 1],
        ["keyboardClose", 1, 0, "keyboard-close", 3],
        ["maxScale", 1, 0, "max-scale", 4],
        ["overlayId", 1, 0, "overlay-id", 4],
        ["present", 6],
        ["translucent", 1, 0, 1, 3],
        ["willAnimate", 1, 0, "will-animate", 3]
      ],
      0,
      [["ionBackdropTap", "onBackdropTap"]]
    ],
    [
      "images-viewer-controller",
      "images-viewer",
      0,
      [
        ["create", 6],
      ...
      0,
      [
        ["body:ionImagesViewerWillPresent", "ImagesViewerWillPresent"],
        ["body:ionImagesViewerWillDismiss", "ImagesViewerWillDismiss"],
        ["body:ionImagesViewerDidUnload", "ImagesViewerWillDismiss"],
        ["body:keyup.escape", "escapeKeyUp"]
      ]
    ]
  ],
